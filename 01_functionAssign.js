var quetion = "Q.1) function with no arguments and no return any value  ";
...
function display() {
  console.log(
    " first function - You can get everything in life you want if you will"
  );
  console.log(
    "                   just help enough other people get what they want"
  );
  console.log(
    " second function- I Never dreamed about SUCCESS I worked for it."
  );
}
...
console.log(line);
console.log(v);
var quetion = "Q.2) function with arguments and no return any values";
console.log(quetion);
...
var line =
  "----------------------------------------------------------------------------------";
console.log(line);
var quetion = "Q.4) Addition of given values  ";
console.log(quetion);
...
console.log(sum_three([10.23, 600, 40]));
let msg = "Hellow ";
